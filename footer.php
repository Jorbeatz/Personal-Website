      ...
      <ul>
        ...
        <li>
          ...
          <div class="adr-group">
            ...
            <span class="adr-info">187 Bridge Rd, NY, Us</span>
          </div>
        </li>
        ...
        <li>
          ...
          <div class="adr-group">
            ...
            <span class="adr-info">jguntur@u.rochester.edu</span>
          </div>
        </li>
        ...
        <li>
          ...
          <div class="adr-group">
            ...
            <span class="adr-info">+ 347 891 7632</span>
          </div>
        </li>
      </ul>
    </address>
  ...
  <div class="copyright">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6">
          <small>&copy; 2017 Jordy Guntur</small>
        </div>
