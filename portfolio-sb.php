...
<html class="no-js" lang="en">
    <head>
        ...
        <title>App Design | Jordy Guntur</title>
        ...
        <header class="page-title pt-large pt-light pt-parallax pt-plax-lg-light" data-stellar-background-ratio="0.4">
          <div class="container">
              <div class="row">
                ...
                <div class="col-sm-6">
                  <h1>SongBox</h1>
                  <span class="subheading">Design Project</span>
                </div>
                <ol class="col-sm-6 text-right breadcrumb">
                  <li><a href="index.php">Home</a></li>
                  <li class="active">Portfolio - Songbox</li>
                </ol>
          ...
          <div class="row ws-m">
            ...
            <div class="col-md-3 mb-sm-50 project-info">
              ...
              <ul>
                ...
                <li><h6>Type:</h6><span>Mobile iOS App Design</span></li>
              </ul>
            </div>
            ...
            <div class="col-md-offset-1 col-md-4 mb-sm-50">
              ...
              <p>Create the design, layout and flow of each screen of the app using Sketch. This includes onboarding, setting, and functionality of screen given only details of what the app aims to accomplish.</p>
            </div>
          ...
          <div class="row">
            <div class="col-md-12">
              <ul class="single-img-slider">
                <li><img src="assets/images/sb/sb-2.png" alt="SongBox-2"></li>
                <li><img src="assets/images/sb/sb-1.png" alt="SongBox-1"></li>
