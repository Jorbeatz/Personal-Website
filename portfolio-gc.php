...
<html class="no-js" lang="en">
    <head>
        ...
        <title>Guntur Cabinetry | Jordy Guntur</title>
        ...
        <section class="section container pfolio-single">
          <div class="row ws-m">
            ...
            <div class="col-md-3 mb-sm-50 project-info">
              ...
              <ul>
                <li><h6>Date:</h6><span>04/20/17</span></li>
            ...
            <div class="col-md-4">
              ...
              <p>Build the website with a page to scroll through and see photos of completed works. Easy.</p>
            </div>
          ...
          <div class="row">
            <div class="col-md-12">
              <ul class="single-img-slider">
                <li><img src="assets/images/gc/gc-1.png" alt="Guntur Cabinetry Homepage"></li>
                <li><img src="assets/images/gc/gc-2.png" alt="Guntur Cabinetry Homepage-2"></li>
                <li><img src="assets/images/gc/gc-3.png" alt="Guntur Cabinetry Cabinets"></li>
                <li><img src="assets/images/gc/gc-4.png" alt="Guntur Cabinetry Mocha-Glazed"></li>
                <li><img src="assets/images/gc/gc-5.png" alt="Guntur Cabinetry Creme-Glazed"></li>
                <li><img src="assets/images/gc/gc-6.png" alt="Guntur Cabinetry Custom Works"></li>
              </ul>
            </div>
          </div><!-- / .row -->
