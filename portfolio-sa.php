          ...
          <div class="container">
              <div class="row">
                ...
                <ol class="col-sm-6 text-right breadcrumb">
                  ...
                  <li class="active">Portfolio - SA</li>
                </ol>
        ...
        <section class="section container pfolio-single">
          <div class="row ws-m">
            ...
            <div class="col-md-offset-1 col-md-4 mb-sm-50">
              ...
              <p>Build a custom website that handles different forms for applications and connect to an RSS feed to display recent news.</p>
            </div>
          ...
          <div class="row">
            <div class="col-md-12">
              <ul class="single-img-slider">
                <li><img src="assets/images/sa/sa-1.png" alt="SA-1"></li>
                <li><img src="assets/images/sa/sa-2.png" alt="SA-2"></li>
                <li><img src="assets/images/sa/sa-3.png" alt="SA-3"></li>
                <li><img src="assets/images/sa/sa-4.png" alt="SA-4"></li>
              </ul>
            </div>
          </div><!-- / .row -->
